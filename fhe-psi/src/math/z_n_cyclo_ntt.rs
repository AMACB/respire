...
//
// impl<const D: usize, const N: u64, const W: u64> From<[Z_N<N>; D]> for IntModCycloEval<D, N, W> {
...
// }
//
// impl<const D: usize, const N: u64, const W: u64> From<PolynomialZ_N<N>> for IntModCycloEval<D, N, W> {
//     fn from(polynomial: PolynomialZ_N<N>) -> Self {
//         IntModCycloEval::from(Z_N_CycloRaw::from(polynomial))
//     }
// }
//
// // See above.
...
// // }
//
// impl<const D: usize, const N: u64, const W: u64> TryFrom<&IntModCycloEval<D, N, W>> for Z_N<N> {
//     type Error = ();
//
...
// }
//
// impl<'a, const D: usize, const N: u64, const W: u64> AddAssign<&'a Self> for IntModCycloEval<D, N, W> {
...
// }
//
// impl<'a, const D: usize, const N: u64, const W: u64> SubAssign<&'a Self> for IntModCycloEval<D, N, W> {
...
// }
//
// impl<'a, const D: usize, const N: u64, const W: u64> MulAssign<&'a Self> for IntModCycloEval<D, N, W> {
...
//                 a[l] /= BASE;
//             }
//             mat[(i + k, j)] = IntModCycloEval::from(Z_N_CycloRaw::from(a_rem));
//         }
//     }
// }
//
...
//         let mut q = IntModCycloEval::<D, P, W>::from(Z_N_CycloRaw::from(vec![1u64]));
//         assert_eq!(p, q);
...
//             pow(root, 7u64),
//         ]);
//         q = IntModCycloEval::<D, P, W>::from(Z_N_CycloRaw::from(vec![0u64, 1u64]));
//         assert_eq!(p, q);
//         assert_eq!(Z_N_CycloRaw::<D, P>::from(p), Z_N_CycloRaw::<D, P>::from(q));
//     }
//
