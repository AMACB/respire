...
pub struct Ciphertext<
    ...
    const G_LEN: usize,
> {
    ct: Matrix<N, M, Z_N_CycloNTT_CRT<D, Q1, Q2, Q1_INV, Q2_INV, W1, W2>>,
}
...
pub struct PublicKey<
    ...
    const G_LEN: usize,
> {
    A: Matrix<N, M, Z_N_CycloNTT_CRT<D, Q1, Q2, Q1_INV, Q2_INV, W1, W2>>,
}
...
impl<
        ...
        const G_BASE: u64,
        const G_LEN: usize,
    > CiphertextRef<P, Ciphertext<N, M, P, Q, Q1, Q2, Q1_INV, Q2_INV, W1, W2, D, G_BASE, G_LEN>>
    for &'a Ciphertext<N, M, P, Q, Q1, Q2, Q1_INV, Q2_INV, W1, W2, D, G_BASE, G_LEN>
{
}
...
impl<
        ...
        const G_BASE: u64,
        const G_LEN: usize,
    > Add for &'a Ciphertext<N, M, P, Q, Q1, Q2, Q1_INV, Q2_INV, W1, W2, D, G_BASE, G_LEN>
{
    type Output = Ciphertext<N, M, P, Q, Q1, Q2, Q1_INV, Q2_INV, W1, W2, D, G_BASE, G_LEN>;
...
impl<
        ...
        const G_BASE: u64,
        const G_LEN: usize,
    > Mul for &'a Ciphertext<N, M, P, Q, Q1, Q2, Q1_INV, Q2_INV, W1, W2, D, G_BASE, G_LEN>
{
    type Output = Ciphertext<N, M, P, Q, Q1, Q2, Q1_INV, Q2_INV, W1, W2, D, G_BASE, G_LEN>;
